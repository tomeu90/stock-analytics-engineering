...
renamed as (
    ...
    select
        ...
        trades :: bigint as qty_trades,
        volume :: bigint as qty_volume,
        average_volume :: bigint as qty_average_volume,
        relative_volume :: double as rt_relative_volume_ratio,
        after_hours_volume :: bigint as qty_after_hours_volume,
        ...
        -- asset valuation
        (market_cap * 1000000) :: bigint as mnt_market_capitalization,
        ...
        (enterprise_value * 1000000) :: bigint as mnt_enterprise_value,
        ...
        -- asset ownership
        (shares_outstanding * 1000000) :: bigint as qty_outstanding_shares,
        (shares_float * 1000000) :: bigint as qty_float_shares,
        ...
        (income * 1000000) :: bigint as mnt_company_income,
        (sales * 1000000) :: bigint as mnt_company_sales,
